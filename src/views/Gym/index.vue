    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column prop="Name" align="center">
          <template slot="header" slot-scope="{}">
            <el-input v-model="search" v-bind:placeholder="$t('Members.Name')" />
          </template>
        </el-table-column>
        ...
        <el-table-column v-bind:label="$t('Members.Status')" width="100" align="center">
        ...
        <el-table-column type="expand" width="30" align="center">
          <template slot-scope="props">
            <el-table :data="[props.row]">
              ...
              <el-table-column  align="center" v-bind:label="$t('Members.MembershipPrice')">
                <template slot-scope="scope">
                  <i class="el-icon-money"></i>
                  {{ scope.row.MembershipPrice.toFixed(2) }}
                </template>
              </el-table-column>
              <el-table-column v-bind:label="$t('Members.MembershipFee')" align="center">
                <template slot-scope="scope">
                  <i class="el-icon-money"></i>
    ...
    >
      ...
      >
        ...
        <div class="row">
          ...
          <div class="col">
            <el-form-item v-bind:label="$t('Members.MembershipPrice')" prop="MembershipPrice">
              <el-input-number
          ...
          <div class="col">
            <el-form-item v-bind:label="$t('Members.MembershipFee')" prop="MembershipFee">
              <el-input-number
