  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column prop="FirstName" align="center">
          <template slot="header" slot-scope="{}">
          ...
          <template slot-scope="props">
            <el-table :data="[props.row]">
              <el-table-column
                ...
                align="center"
              ></el-table-column>
              <el-table-column v-bind:label="$t('Members.Gender')" prop="Gender" width="50"></el-table-column>
    ...
    >
      <el-form  :model="tempForm"  ref="dataForm" class="demo-form-inline">
        <div>
          <el-radio v-model="tempForm.Gender" label="Male" border>Male</el-radio>
          <el-radio v-model="tempForm.Gender" label="Female" border>Female</el-radio>
        </div>
        <el-form-item v-bind:label="$t('AddMembers.Name')" prop="FirstName">
          <el-input type="text" v-model="tempForm.FirstName"></el-input>
        </el-form-item>
          <el-form-item
            label="تاريخ ميلاد"
            prop="DateofBirth"
        ...
        <el-form-item v-bind:label="$t('AddMembers.PhoneNumber1')" prop="PhoneNumber1">
          <el-input type="text" v-model="tempForm.PhoneNumber1"></el-input>
        </el-form-item>
        <el-form-item v-bind:label="$t('AddMembers.PhoneNumber2')" prop="PhoneNumber2">
          <el-input type="text" v-model="tempForm.PhoneNumber2"></el-input>
        </el-form-item>
        <el-form-item v-bind:label="$t('AddMembers.Email')" prop="Email">
          <el-input type="text" v-model="tempForm.Email"></el-input>
        </el-form-item>
        <el-form-item v-bind:label="$t('AddMembers.Description')" prop="Description">
          <el-input type="textarea" v-model="tempForm.Description"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogFormVisible = false">{{$t('AddMembers.Cancel')}}</el-button>
        <el-button
          type="primary"
          @click="dialogFormStatus==='create'?createData():updateData()"
        >{{$t('AddMembers.Save')}}</el-button>
      </div>
    </el-dialog>
    <el-dialog
      style="margin-top: -13vh"
...
<script>
import { GetMember, Create, Edit } from "@/api/Member";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      this.tempForm.FirstName = row.FirstName;
      this.tempForm.Gender = row.Gender;
      ...
      this.tempForm.Type = row.Account.Type;
