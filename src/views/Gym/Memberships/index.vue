  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column prop="Name" align="center">
          <template slot="header" slot-scope="{}">
            <el-input v-model="search" v-bind:placeholder="$t('Memberships.Name')" />
          </template>
        </el-table-column>
        <el-table-column v-bind:label="$t('Memberships.TotalMembers')" width="220" align="center">
          <template slot-scope="scope">{{ scope.row.TotalMembers }}</template>
        </el-table-column>
        <el-table-column v-bind:label="$t('Memberships.Status')" width="100" align="center">
        ...
        <el-table-column type="expand" width="30" align="center">
          <template slot-scope="props">
            <el-table :data="[props.row]">
              <el-table-column  align="center" v-bind:label="$t('Memberships.NumberDays')">
                <template slot-scope="scope">
                  <i class="el-icon-time"></i>
                  {{ scope.row.NumberDays }}
                </template>
              </el-table-column>
              <el-table-column  align="center" v-bind:label="$t('Memberships.MembershipPrice')">
                <template slot-scope="scope">
                  <i class="el-icon-money"></i>
                  {{ scope.row.MembershipPrice.toFixed(2) }}
                </template>
              </el-table-column>
              <el-table-column v-bind:label="$t('Memberships.MembershipFee')" align="center">
                <template slot-scope="scope">
                  <i class="el-icon-money"></i>
                  {{ scope.row.MembershipFee.toFixed(2) }}
                </template>
              </el-table-column>
              <el-table-column v-bind:label="$t('Memberships.Tax')" align="center" prop="Tax"></el-table-column>
              <el-table-column v-bind:label="$t('Memberships.Rate')" align="center" prop="Rate"></el-table-column>
              <el-table-column
               align="center"
                v-bind:label="$t('Memberships.Notes')"
                prop="Description"
                width="150"
              ></el-table-column>
            </el-table>
    ...
    >
      <el-form
        ...
        label-width="70px"
      >
        <el-form-item v-bind:label="$t('Memberships.Name')" prop="Name">
          <el-input type="text" v-model="tempForm.Name"></el-input>
        </el-form-item>

        <div class="row">
          <div class="col">
            <el-form-item v-bind:label="$t('Memberships.NumberDays')" prop="NumberDays">
              <el-input-number v-model="tempForm.NumberDays" :step="1" :min="1" :max="1000"></el-input-number>
            </el-form-item>
          </div>
          <div class="col">
            <el-form-item v-bind:label="$t('Memberships.MembershipPrice')" prop="MembershipPrice">
              <el-input-number
                v-model="tempForm.MembershipPrice"
                :precision="2"
                :step="0.1"
                :min="0.00"
                :max="1500"
          ...
          <div class="col">
            <el-form-item v-bind:label="$t('Memberships.MembershipFee')" prop="MembershipFee">
              <el-input-number
                v-model="tempForm.MembershipFee"
                :precision="2"
                :step="0.1"
                :min="0.00"
                :max="1500"
        ...
        <div class="row">
          <div class="col">
            <el-form-item v-bind:label="$t('Memberships.Tax')" prop="Tax">
              <el-input-number
        ...
        <el-form-item v-bind:label="$t('Memberships.Notes')" prop="Description">
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      this.tempForm.MembershipPrice = row.MembershipPrice;
      this.tempForm.MembershipFee = row.MembershipFee;
