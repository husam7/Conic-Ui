<template>
  <div class="app-container">
    <el-card class="box-card">
      ...
      <el-table
        v-loading="loading"
        :data="tableData.filter(data => !search || data.OriginName.toLowerCase().includes(search.toLowerCase()))"
        fit
        border
        max-height="900"
      ...
      >
        ...
        <el-table-column v-bind:label="$t('Classification.Name')" prop="OriginName"  align="center">
          <template slot="header" slot-scope="{}">
            <el-input v-model="search" v-bind:placeholder="$t('Classification.OriginName')"/>
          </template>
        </el-table-column>
        <el-table-column
          ...
          align="center"
        ></el-table-column>
        <el-table-column v-bind:label="$t('Classification.Notes')" prop="Description" width="220" align="center"></el-table-column>
    ...
    >
      <el-form
        ...
        label-width="70px"
      >
        <el-form-item v-bind:label="$t('Classification.OriginName')" prop="OriginName">
          <el-input type="text" v-model="tempForm.OriginName"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      this.tempForm.OriginName = row.OriginName;
