<template>
  <div class="app-container">
        ...
        <el-table-column type="expand" width="30">
          <template slot-scope="props">
            <el-table :data="[props.row]">
              ...
              <el-table-column v-bind:label="$t('Items.LowerOrder')" prop="LowOrder" width="110" align="center"></el-table-column>
              ...
              <el-table-column v-bind:label="$t('Items.Notes')" prop="Description" width="150" align="center"></el-table-column>
            </el-table>
          </template>
        </el-table-column>
      </el-table>
   ...
   <!--
        ...
        <el-form-item v-bind:label="$t('Items.Name')" prop="Name">
...
<script>
import { GetItem, CreateItem, Edit } from "@/api/Item";
