  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column prop="Qty" v-bind:label="$t('ItemSales.quantity')" width="120" align="center">
          <template slot-scope="scope">{{(scope.row.Qty).toFixed(3) }}</template>
        </el-table-column>
        <el-table-column prop="SellingPrice" v-bind:label="$t('ItemSales.Price')" width="120" align="center">
